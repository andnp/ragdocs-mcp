...
- **Tranche 5 — Soft Project Semantics:** in progress. `project_id` metadata now propagates from ingest into chunk/query results; ranking uplift and multi-project doc rewrites remain outstanding.
