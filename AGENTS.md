...
- Do not invent or assume deleted memory features still exist in Ragdocs

**Example scenarios:**
- "Add a section to README.md" → Use file editor
- "Create a new spec document" → Use file editor

### Query vs. Content Distinction

**Query tools** (`query_documents`, `search_git_history`, `search_with_hypothesis`) are for **finding existing content**:
