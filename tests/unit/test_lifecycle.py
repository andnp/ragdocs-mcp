...
class TestLifecycleStateMachine:
    ...
    async def test_start_runs_huey_worker_in_thread(self, monkeypatch) -> None:
        ...
        monkeypatch.setattr("mcp_markdown_ragdocs.lifecycle.LeaderElection", _FakeLeaderElection)
        monkeypatch.setattr("mcp_markdown_ragdocs.lifecycle.asyncio.to_thread", _fake_to_thread)
    ...
    async def test_start_uses_context_git_discovery_for_git_watcher(
        ...
        monkeypatch.setattr("mcp_markdown_ragdocs.lifecycle.GitWatcher", _FakeGitWatcher)
        monkeypatch.setattr("mcp_markdown_ragdocs.lifecycle.asyncio.to_thread", _fake_to_thread)
...
class TestWorkerSupervision:
    ...
    async def test_supervision_restarts_unhealthy_worker(self) -> None:
        ...
        with (
            patch("mcp_markdown_ragdocs.lifecycle.asyncio.sleep", _fake_sleep),
