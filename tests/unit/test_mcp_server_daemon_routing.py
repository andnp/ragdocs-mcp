...
async def test_mcp_server_prefers_daemon_tool_listing(monkeypatch):
    ...
    monkeypatch.setattr(
        "mcp_markdown_ragdocs.mcp.server.start_daemon",
    ...
    monkeypatch.setattr(
        "mcp_markdown_ragdocs.mcp.server.request_daemon_socket",
...
async def test_mcp_server_does_not_wait_for_ready_daemon_before_tool_call(monkeypatch):
    ...
    monkeypatch.setattr(
        "mcp_markdown_ragdocs.mcp.server.wait_for_daemon_ready",
...
async def test_mcp_server_retries_tool_call_after_timeout(monkeypatch):
    ...
    monkeypatch.setattr(
        "mcp_markdown_ragdocs.mcp.server.inspect_daemon",
    ...
    monkeypatch.setattr("mcp_markdown_ragdocs.mcp.server.request_daemon_socket", _fake_request)
...
async def test_mcp_server_startup_does_not_forward_project_context(monkeypatch):
    ...
    def _fake_start_daemon(*, cwd=None, project_override=None, timeout_seconds=30.0, paths=None):
    ...
    monkeypatch.setattr("mcp_markdown_ragdocs.mcp.server.start_daemon", _fake_start_daemon)
