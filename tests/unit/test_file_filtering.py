...
def test_include_all_pattern():
    ...
    result = _should_include_file(
        "/path/to/file.md", include_patterns=["**/*"], exclude_patterns=[]
    )
...
def test_include_specific_extension():
    ...
    result_md = _should_include_file(
        "/project/docs/README.md", include_patterns=["**/*.md"], exclude_patterns=[]
    )
    assert result_md is True

    result_txt = _should_include_file(
        "/project/docs/notes.txt", include_patterns=["**/*.md"], exclude_patterns=[]
    )
...
def test_exclude_hidden_dirs_enabled():
    ...
    assert (
        ...
        is False
    )  # This is in a hidden "dir" conceptually (file itself starts with .)
